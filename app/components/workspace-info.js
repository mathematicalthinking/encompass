/*global _:false */
Encompass.WorkspaceInfoComponent = Ember.Component.extend(
  ...
  Encompass.ErrorHandlingMixin,
  {
    ...
    customSubmissionIds: [],
    isParentWorkspace: Ember.computed.equal(
    ...
    actions: {
      ...
      updateCustomSubs(id) {
        if (
          !this.get("utils").isNonEmptyArray(this.get("customSubmissionIds"))
        ) {
