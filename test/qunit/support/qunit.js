...
(function (window) {
  ...
  Test.prototype = {
    ...
    setup: function () {
      ...
      try {
        ...
        QUnit.pushFailure(
          'Setup failed on ' + this.testName + ': ' + e.message,
    ...
    teardown: function () {
      ...
      if (config.notrycatch) {
        ...
        try {
          ...
          QUnit.pushFailure(
            'Teardown failed on ' + this.testName + ': ' + e.message,
            extractStacktrace(e, 1)
          );
        }
      }
  ...
  QUnit = {
    ...
    test: function (testName, expected, callback, async) {
      var test,
        name =
          "<span class='test-name'>" + escapeInnerText(testName) + '</span>';
  ...
  QUnit.load = function () {
    ...
    moduleFilterHtml +=
      ...
      (config.module === undefined ? 'selected' : '') +
      '>< All Modules ></option>';
