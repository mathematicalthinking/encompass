  ...
  })(
    {
      1: [
        function (_dereq_, module, exports) {
          'use strict';
          var testResolver =
            _dereq_('./test-resolver')['default'] || _dereq_('./test-resolver');
      ...
      2: [
        function (_dereq_, module, exports) {
          'use strict';
          var Ember = window.Ember['default'] || window.Ember;
          var isolatedContainer =
            _dereq_('./isolated-container')['default'] ||
            _dereq_('./isolated-container');
          var moduleFor =
            _dereq_('./module-for')['default'] || _dereq_('./module-for');
          var moduleForComponent =
            _dereq_('./module-for-component')['default'] ||
            _dereq_('./module-for-component');
          var moduleForModel =
            _dereq_('./module-for-model')['default'] ||
            _dereq_('./module-for-model');
        ...
        {
          './isolated-container': 1,
          './module-for': 5,
          './module-for-component': 3,
          './module-for-model': 4,
          './test': 8,
          './test-resolver': 7,
        },
      ...
      3: [
        function (_dereq_, module, exports) {
          ...
          exports['default'] = function moduleForComponent(
            name,
            description,
            callbacks
          ) {
            ...
            moduleFor(
              ...
              function (container, context, defaultSubject) {
                ...
                context.__setup_properties__.append = function () {
                  Ember.deprecate(
                    'this.append() is deprecated. Please use this.render() instead.'
                  );
                  return this.render();
                };
      ...
      4: [
        function (_dereq_, module, exports) {
          ...
          exports['default'] = function moduleForModel(
            name,
            description,
            callbacks
          ) {
            if (!DS)
              throw new Error(
                'You must have Ember Data installed to use `moduleForModel`.'
              );
            ...
            moduleFor(
              ...
              function (container, context, defaultSubject) {
                ...
                var adapterFactory = container.lookupFactory(
                  'adapter:application'
                );
                if (!adapterFactory) {
      ...
      5: [
        function (_dereq_, module, exports) {
          ...
          var testContext =
            _dereq_('./test-context')['default'] || _dereq_('./test-context');
          var isolatedContainer =
            _dereq_('./isolated-container')['default'] ||
            _dereq_('./isolated-container');

          exports['default'] = function moduleFor(
            fullName,
            description,
            callbacks,
            delegate
        ...
        { './isolated-container': 1, './test-context': 6 },
      ],
      6: [
        function (_dereq_, module, exports) {
          'use strict';
        ...
        function (_dereq_, module, exports) {
          ...
          exports['default'] = function test(testName, callback) {
            function wrapper() {
              ...
              Ember.run(function () {
                stop();
                Ember.RSVP.Promise.cast(result)
                  ['catch'](failTestOnPromiseRejection)
                  ['finally'](start);
              });
            }
