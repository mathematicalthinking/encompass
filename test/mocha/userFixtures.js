const admin = {
  ...
  workspaces: {
    ...
    accessibleWorkspace: {
      ...
      submissions: [
        '53e1156db48b12793f000418',
        '53e1156db48b12793f00042e',
        '53e1156db48b12793f000420',
        '53e1156db48b12793f000425',
        '53e1156db48b12793f000416',
        '53e1156db48b12793f000421',
        '53e1156db48b12793f000432',
        '53e1156db48b12793f000436',
        '53e1156db48b12793f00041a',
        '53e1156db48b12793f00042f',
        '53e1156db48b12793f00041e',
        '53e1156db48b12793f000430',
        '53e1156db48b12793f00043e',
        '53e1156db48b12793f000419',
        '53e1156db48b12793f00042d',
        '53e1156db48b12793f000438',
        '53e1156db48b12793f00041b',
        '53e1156db48b12793f000434',
        '53e1156db48b12793f000417',
        '53e1156db48b12793f000427',
        '53e1156db48b12793f000423',
        '53e1156db48b12793f000440',
        '53e1156db48b12793f000407',
        '53e1156db48b12793f000437',
        '53e1156db48b12793f000422',
        '53e1156db48b12793f000433',
        '53e1156db48b12793f000428',
        '53e1156db48b12793f00043d',
        '53e1156db48b12793f00042c',
        '53e1156db48b12793f00041d',
        '53e1156db48b12793f000439',
        '53e1156db48b12793f000414',
        '53e1156db48b12793f00041f',
        '53e1156db48b12793f00043a',
        '53e1156db48b12793f000415',
        '53e1156db48b12793f000426',
      ],
      comments: [
        '53e12264b48b12793f000b84',
        '53e12507b48b12793f000b91',
        '5bbbba86a6a7ee1a9a5ebc75',
      ],
      responses: ['5b1aef7ae53645e768926123'],
      taggings: [
        '53e1194bb48b12793f000a62',
        '53e11b5eb48b12793f000abb',
        '53e11eceb48b12793f000b36',
        '53e11fa8b48b12793f000b48',
        '53e12250b48b12793f000b83',
        '53e12518b48b12793f000b92',
      ],
      selections: [
        '53e11942b48b12793f000a5f',
        '53e11b38b48b12793f000ab7',
        '53e11ec4b48b12793f000b34',
        '53e11f20b48b12793f000b3a',
        '53e11f82b48b12793f000b44',
        '53e12158b48b12793f000b68',
        '53e12211b48b12793f000b7e',
        '53e1223cb48b12793f000b80',
        '53e1223eb48b12793f000b81',
        '53e12503b48b12793f000b90',
        '5bbbba75a6a7ee1a9a5ebc74',
      ],
      permissions: [],
      feedbackAuthorizers: [],
      folders: [
        '53e11604b48b12793f0004ee',
        '53e1165eb48b12793f0005e7',
        '53e1166db48b12793f0005e9',
        '53e118f3b48b12793f000a41',
        '53e11b0ab48b12793f000ab1',
      ],
    },
  },
  responses: {
...
const pdAdminDrexel = {
  ...
  workspaces: {
    ...
    accessibleWorkspace: {
      ...
      submissions: ['5bec36958c73047613e2f34c', '5bec36958c73047613e2f34d'],
      comments: [
      ...
      responses: ['5c87ddf1a2fb212cd72de56a', '5c87de03a2fb212cd72de56c'],
      taggings: [
...
const studentMT = {
  ...
  answers: {
    ...
    firstRevision: {
      ...
      isSubmitted: true,
      students: ['5b914a102ecaf7c30dd47492'],
  ...
  workspaces: {
    ...
    accessibleWorkspace: {
      ...
      comments: ['5bec375d8c73047613e2f35e', '5bec37708c73047613e2f35f'],
      responses: ['5bec64f7aa4a927d50cd5ba0', '5c87de03a2fb212cd72de56c'],
      taggings: [],
      selections: ['5bec373d8c73047613e2f35c', '5bec37408c73047613e2f35d'],
      permissions: [],
      folders: [],
      feedbackAuthorizers: [],
    },
