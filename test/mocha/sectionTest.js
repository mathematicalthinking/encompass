    ...
    describe(`Section CRUD operations as ${user.details.testDescriptionTitle}`, function () {
      ...
      describe('/GET accessible section by ID', () => {
        it('should return 1 section with matching id', (done) => {
          agent.get(baseUrl + accessibleSection._id).end((err, res) => {
            if (err) {
              console.error(err);
            }
            expect(res).to.have.status(200);
          ...
          agent
            ...
            .end((err, res) => {
              ...
              if (isStudent) {
                ...
                expect(res).to.have.status(200);
                expect(res.body.section).to.have.any.keys(
                  'name',
                  'assignments',
                  'students',
                  'teachers'
          ...
          it('should add one teacher to the section', (done) => {
            ...
            agent
              ...
              .end((err, res) => {
                ...
                expect(res.body.section.teachers).to.have.members(
                  modifiableSection.newTeachers
                );
                expect(res.body.section.teachers).to.contain(
                  modifiableSection.teacherToAdd
                );
                done();
              });
          });
              ...
              .then((results) => {
                ...
                expect(
                  _.find(
                    sections,
                    (obj) =>
                      obj.sectionId.toString() === modifiableSection._id &&
                      obj.role === 'teacher'
                  )
                ).to.exist;
                expect(
                  _.find(
                    sections,
                    (obj) =>
                      obj.sectionId === modifiableSection._id &&
                      obj.role === 'student'
                  )
                ).to.not.exist;
                return;
          ...
          it('should add one student to the section', (done) => {
            ...
            agent
              ...
              .end((err, res) => {
                ...
                expect(res.body.section.students).to.have.members(
                  modifiableSection.newStudents
                );
                expect(res.body.section.students).to.contain(
                  modifiableSection.studentToAdd
                );
                done();
              });
          });
          ...
          it('should return an empty array', (done) => {
            agent
              ...
              .end((err, res) => {
                ...
                expect(res.body.section.teachers).to.not.contain(
                  fixtures.teacher._id
                );
                done();
              });
          });
        ...
        it('should return an empty array', (done) => {
          agent
            ...
            .end((err, res) => {
              ...
              expect(res.body.section.students).to.not.contain(
        ...
        it('should add one problem to the section', (done) => {
          ...
          agent
            ...
            .end((err, res) => {
              ...
              expect(res.body.section.problems).to.contain(
                fixtures.problem._id
              );
              done();
            });
        });
        ...
        it('should return an empty array', (done) => {
          agent
            ...
            .end((err, res) => {
              ...
              expect(res.body.section.problems).to.not.contain(
                fixtures.problem._id
              );
              done();
            });
