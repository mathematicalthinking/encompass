module.exports = {
  ...
  problemNew: {
    problemNewHeading:
      '#problem-new .side-info-menu .info-details .info-main .heading',
    problemNewBtn: 'div.searchbar #problem-new-link',
    menuTab:
      '#problem-new .side-info-menu .info-details .info-menu button.tab-name.',
    inputLabel:
      '#problem-new .side-info-menu .info-content .info-content-label.',
    inputTextbox:
      '#problem-new .side-info-menu .info-content .info-content-block .input-container input',
    inputQuill:
      '#problem-new .side-info-menu .info-content .info-content-block .quill-container section',
    inputContentBlock:
      '#problem-new .side-info-menu .info-content .info-content-block',
    privacySetting:
      '#problem-new .side-info-menu .info-content .info-content-block.privacy ul li.radio-item label.radio-label input.everyone',
    selectedCatsList:
      '#problem-new .side-info-menu .info-content .info-content-block.categories ul.problem-info li.category-item',
    removeCategoryBtn:
      '#problem-new .side-info-menu .info-content .info-content-block.categories ul.problem-info li.category-item:first-child button.remove-cat',
    showCatsBtn: 'button.show-cats-btn',
    hideCatsBtn: 'button.hide-cats-btn',
    inputSelectize:
      '#problem-new .side-info-menu .info-content .info-content-block .selectize-comp',
    inputSelectizeType:
      '#problem-new .side-info-menu .info-content .info-content-block .selectize-comp  .selectize-control .selectize-input input',
    errorMsgGeneral: 'Please provide all required fields',
    errorMsgLegal:
      'Please verify that you have permission to post this problem',
    errorMsgTitle:
      'There is already an existing public problem titled "Alphabetical Problem."',
    errorBoxDismiss: '.error-box p button i.fa-times',
    primaryButton:
      'section.info-actions .buttons-container .right-buttons button.primary-button',
    cancelButton:
      'section.info-actions .buttons-container .right-buttons button.cancel-button',
  },
  ...
  problemInfo: {
    ...
    problemName:
      '#problem-info .side-info-menu .info-details .info-main .heading',
    problemDate:
      '#problem-info .side-info-menu .info-details .info-main .subheading.date',
    problemMenuTab:
      '#problem-info .side-info-menu .info-details .info-menu button.tab-link.',
    problemStatement:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block p',
    problemStatementCont:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.statement',
    problemAuthor:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.author',
    problemOrg:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.org',
    problemStatus:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block .status-text',
    flagReasonBtn:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block .show-reason',
    flagReasonCont:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block div.flag-reason',
    flagReason:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block div.flag-reason p.reason',
    flagReasonDetails:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block div.flag-reason p.details',
    problemCategory:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block ul li.category-item a',
    problemCategoryNone:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.categories',
    problemCategoryItem:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block ul li.category-item',
    problemCategoryHeader:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.categories',
    problemKeyword:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.keywords ul li',
    problemKeywordNone:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.keywords',
    problemKeywordHeader:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.keywords',
    additionalInfo:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.additional',
    additionalImage:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.image',
    origin:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.origin',
    creator:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.creator',
    copyright:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.copyright p',
    copyrightNone:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.copyright',
    sharingAuth:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.sharing',
    assignButton:
      'section.info-actions .buttons-container .right-buttons button.primary-button.assign',
    editButton:
      'section.info-actions .buttons-container .right-buttons button.primary-button.edit',
    copyButton:
      'section.info-actions .buttons-container .left-buttons span button i.fa-copy',
    recommendButton:
      'section.info-actions .buttons-container .left-buttons span button.star-icon',
  },

  problemEdit: {
    privacySettingIcon: '#problem-info .info-header span.top-left-icon i',
    privacySettingSelect:
      '#problem-info .info-header div.select-container select#privacy-select',
    problemNameInput:
      '#problem-info .side-info-menu .info-details .info-main .heading input#title',
    problemDate:
      '#problem-info .side-info-menu .info-details .info-main .subheading.date',
    problemMenuTab:
      '#problem-info .side-info-menu .info-details .info-menu button.tab-link.',
    problemStatement:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block div.quill-container section#editor div.ql-editor',
    problemAuthor:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.author div.input-container input#author',
    problemStatus:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block .my-select',
    problemStatusFixed:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block .status-text',
    problemCategoryItem:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block ul li.category-item',
    ...
    problemCategoryAdd:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.categories div button.cancel-button',
    problemCategoryList:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.categories ul li',
    keywordParent:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.keywords .selectize-comp #select-edit-keywords div.selectize-control.multi',
    keywordInput:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.keywords .selectize-comp div.selectize-control.multi div.selectize-input input#select-edit-keywords-selectized',
    keywordsListing:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.keywords ul li',
    additionalInfo:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.additional div.input-container textarea.additional-info-area',
    additionalImage:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.image div.input-container div#image-upload',
    origin:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.origin p a',
    creator:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.creator p a',
    copyright:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.copyright input#copyright',
    sharingAuth:
      '#problem-info .side-info-menu .info-details .info-content .info-content-block.sharing input#sharing',
    deleteButton:
      'section.info-actions .buttons-container .left-buttons button.button-icon i.fa-trash',
    cancelButton:
      'section.info-actions .buttons-container .right-buttons button.cancel-button',
    saveButton:
      'section.info-actions .buttons-container .right-buttons button.save',
    errorBox: 'div.error-box',
    errorBoxText:
      '#problem-info .side-info-menu div.error-box p span.error-text',
    errorBoxDismiss:
      '#problem-info .side-info-menu div.error-box p button.dismiss i',
  },

  longString:
    'Pellentesque suscipit efficitur turpis, ut auctor nisl gravida vitae. Aliquam venenatis, lacus id tristique placerat, est diam vehicula magna, nec ultricies nunc massa sit amet tortor. Interdum et malesuada fames ac ante ipsum primis in faucibus. Donec dignissim, ipsum a congue pulvinar, arcu tellus aliquam velit, sit amet dictum dui elit at ligula. Morbi sed felis et diam tincidunt efficitur. Pellentesque vehicula vehicula iaculis. Ut aliquam urna metus. Vestibulum metus purus, dignissim in vestibulum.',
  assignmentsStudent: {
  ...
  responseInfo: {
    submissionView: {
      studentIndicator:
        '#response-submission-view > div.submission-container > div.submission-student > span',
  ...
  wsInfo: {
    ...
    settings: {
      ...
      cancelEdit:
        '#workspace-info-settings > div > div.card-content > div.card-row.button-row > button.primary-button.cancel-button',
      saveEdit:
        '#workspace-info-settings > div > div.card-content > div.card-row.button-row > button:nth-child(2)',
      editName: '#edit-name-input',
      nameText:
        '#workspace-info-settings > div > div.card-content > div:nth-child(1) > div.row-value',
    ...
    collabs: {
      ...
      saveCollab:
        '#workspace-info-collaborators-new > div > div:nth-child(3) > div > button:nth-child(2)',
      collabItems:
        '#workspace-info-collaborators > div > div.card-content > div',
      permissionsList: {
