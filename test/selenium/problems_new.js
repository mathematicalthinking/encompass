        ...
        if (!isStudent) {
          describe('Clicking on problem new page', function () {
            ...
            it('should open problem new page from topbar', async function () {
              ...
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.problemNewHeading
                )
              ).to.contain('Create New Problem');
            });
            ...
            it('should show a new problem form with 4 headers', async function () {
              ...
              expect(await helpers.checkSelectorsExist(driver, selectors)).to.be
                .true;
            });
            ...
            it('the general page should have four inputs with labels', async function () {
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'title',
                  true
                )
              ).to.contain('problem title');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputTextbox + '#title'
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'statement',
                  true
                )
              ).to.contain('problem statement');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputQuill + '#editor'
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'author',
                  true
                )
              ).to.contain('author');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputTextbox + '#author'
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'privacy',
                  true
                )
              ).to.contain('privacy');
              expect(
                await helpers.getWebElements(
                  driver,
                  css.problemNew.inputContentBlock + ' ul li'
                )
              ).to.have.lengthOf(3);
            });
            ...
            it('should show an error if navigating to next page without filling in required fields', async function () {
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.primaryButton
              );
              await driver.sleep(800);
              await helpers.waitForTextInDom(
                driver,
                css.problemNew.errorMsgGeneral
              );
              expect(
                await helpers.findAndGetText(driver, '.error-box')
              ).to.contain(css.problemNew.errorMsgGeneral);
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.errorBoxDismiss
              );
            });
            ...
            it('should show a modal if creating a public problem and go to next page', async function () {
              ...
              await helpers.findInputAndType(
                driver,
                css.problemNew.inputQuill + '#editor .ql-editor',
                problem.text
              );
              await helpers.findInputAndType(
                driver,
              ...
              ).to.contain('are you sure you want to create a public problem');
              await helpers.waitForAndClickElement(
                driver,
              ...
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'categories',
                  true
                )
              ).to.contain('problem categories');
            });
            ...
            it('the categories page should have two inputs with labels', async function () {
              ...
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.showCatsBtn
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'keywords',
                  true
                )
              ).to.contain('problem keywords');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputSelectize
                )
              ).to.be.true;
            });
            ...
            it('should let you continue without selecting categories or keywords', async function () {
              ...
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'additional',
                  true
                )
            ...
            it('should let you continue without adding any additional info', async function () {
              ...
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'copyright',
                  true
                )
              ).to.contain('copyright notice');
            });

            it('should let you go back to categories page', async function () {
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.cancelButton
              );
              expect(
                await helpers.findAndGetText(
                  driver,
            ...
            it('should let you add categories to problem', async function () {
              ...
              expect(
                await helpers.getWebElements(
                  driver,
                  css.problemNew.selectedCatsList
                )
              ).to.have.lengthOf(2);
            });
            ...
            it('should let you remove categories to problem', async function () {
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.removeCategoryBtn
              );
              await driver.sleep(500);
              expect(
                await helpers.getWebElements(
            ...
            it('should let you add problem keywords', async function () {
              ...
              await helpers.findInputAndType(
                driver,
                css.problemNew.inputSelectizeType,
                keywords[0],
                true
              );
              await helpers.findInputAndType(
            ...
            it('the additional page should have two inputs with labels', async function () {
              ...
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputContentBlock +
              ...
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'image',
                  true
                )
              ).to.contain('additional image');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputContentBlock + ' #image-upload'
                )
              ).to.be.true;
            });
            ...
            it('should type in additional info and continue to next page', async function () {
              await helpers.findInputAndType(
                driver,
                css.problemNew.inputContentBlock + ' .input-container textarea',
            ...
            it('the legal page should have three inputs with labels', async function () {
              ...
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputTextbox + '#copyright'
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'sharing',
                  true
                )
              ).to.contain('sharing authorization');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputTextbox + '#sharing'
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputLabel + 'legal',
                  true
                )
              ).to.contain('legal notice');
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemNew.inputContentBlock + ' #legal-notice'
                )
              ).to.be.true;
            });
            ...
            it('should show an error when trying to submit without checking legal notice', async function () {
              ...
              await helpers.waitForTextInDom(
                driver,
                css.problemNew.errorMsgLegal
              );
              expect(
                await helpers.findAndGetText(driver, '.error-box')
              ).to.contain(css.problemNew.errorMsgLegal);
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.errorBoxDismiss
              );
            ...
            it('the general page should have inputs still filled in and change title to duplicate', async function () {
              ...
              ).to.contain(problem.startTitle);
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemNew.inputQuill + '#editor .ql-editor p'
                )
              ).to.contain(problem.text);
            ...
            it('the additional page should still have inputs filled in', async function () {
              expect(
                await helpers.getWebElementValue(
                  driver,
                  css.problemNew.inputContentBlock +
                    ' .input-container input#additionalInfo'
                )
              ).to.contain(problem.additionalInfo);
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.primaryButton
              );
            ...
            it('the legal page should still have inputs filled in', async function () {
              ...
              ).to.contain(problem.copyrightNotice);
              expect(
                await helpers.getWebElementValue(
                  driver,
                  css.problemNew.inputTextbox + '#sharing'
                )
              ).to.contain(problem.sharingAuth);
            });
            ...
            it('creating a problem with duplicate name should throw error', async function () {
              ...
              await helpers.waitForTextInDom(
                driver,
                css.problemNew.errorMsgTitle
              );
              expect(
                await helpers.findAndGetText(driver, '.error-box')
              ).to.contain(css.problemNew.errorMsgTitle);
              await helpers.waitForAndClickElement(
                driver,
                css.problemNew.errorBoxDismiss
              );
              ...
              ).to.contain(problem.duplicateTitle);
            });
            ...
            it('newly created problem - general page should have correct info', async function () {
              expect(
                await helpers.isElementVisible(
                  driver,
                  css.problemInfo.privacySetting + 'fa-globe-americas'
                )
              ).to.be.true;
              expect(
                await helpers.findAndGetText(
              ...
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemInfo.problemStatement
                )
              ).to.contain(problem.text);
              expect(
                await helpers.findAndGetText(
            ...
            it('newly created problem - categories page should have correct info', async function () {
              ...
              ).to.contain(problem.category);
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemInfo.problemKeyword + ':first-child'
                )
              ).to.contain(problem.keywords[0]);
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemInfo.problemKeyword + ':nth-child(2)'
                )
              ).to.contain(problem.keywords[1]);
              expect(
                await helpers.findAndGetText(
                  driver,
                  css.problemInfo.problemKeyword + ':nth-child(3)'
                )
              ).to.contain(problem.keywords[2]);
            });
            ...
            it('newly created problem - legal page should have correct info', async function () {
              ...
              await driver.sleep(800);
              expect(
                await helpers.findAndGetText(driver, css.problemInfo.copyright)
              ).to.contain(problem.copyrightNotice);
              expect(
                await helpers.findAndGetText(
                  driver,
