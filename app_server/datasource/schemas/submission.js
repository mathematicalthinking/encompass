...
EncompassSubmissionSchema.set('toObject', {
  transform: insertTeacher,
  minimize: false,
  virtuals: true,
});
EncompassSubmissionSchema.set('toJSON', {
  transform: insertTeacher,
  minimize: false,
  virtuals: true,
});
...
module.exports.PDSubmission = mongoose.model(
  'PDSubmission',
  PDSubmissionSchema
);
module.exports.Submission = mongoose.model(
  'Submission',
  EncompassSubmissionSchema
);
