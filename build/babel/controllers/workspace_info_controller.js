...
Encompass.WorkspaceInfoController = Ember.Controller.extend(Encompass.CurrentUserMixin, {
  ...
  actions: {
    removeEditor: function removeEditor(editor) {
      var workspace = this.get('model');
      workspace.get('editors').removeObject(editor);
    },
    addEditor: function addEditor(editor) {
      var workspace = this.get('model');
    ...
    editWorkspace: function editWorkspace() {
...
//# sourceMappingURL=workspace_info_controller.js.map
