...
Encompass.FoldersController = Ember.Controller.extend(Encompass.CurrentUserMixin, {
  ...
  filteredContent: function () {
    var filteredContent = this.get('content').filterProperty('isTrashed', false).filterProperty('parent', null);

    var sortedContent = Ember.ArrayProxy.createWithMixins(Ember.SortableMixin, { content: filteredContent, sortProperties: this.sortProperties });
  ...
  siblings: function siblings(folder, above) {
    var controller = this,
        ...
        workspaceFolders = workspace.get('folders').filterBy('parent.id', parentID).sortBy('weight', 'name');
  ...
  */
  actions: {
    ...
    putInFolder: function putInFolder(folder, type, obj) {
      var controller = this;
    ...
    putInWorkspace: function putInWorkspace(obj) {
      var controller = this;
      var workspaceController = controller.get('controllers.workspace');
...
//# sourceMappingURL=folders_controller.js.map
