...
Encompass.CommentListComponent = Ember.Component.extend({
  ...
  labels: {
    ...
    feedback: {
      placeholder: ['Interesting...', 'Did you try...', 'What about...', 'I am interested in...', 'I would like...', 'Seems promising...', 'What if...', 'How do you know...', 'Can you say more...'],
      useForResponse: true
    }
  },
  ...
  clearCommentParent: function clearCommentParent() {
  ...
  actions: {
    ...
    reuseComment: function reuseComment(comment) {
    ...
    setCommentLabel: function setCommentLabel(label) {
