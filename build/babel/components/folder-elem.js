...
Encompass.FolderElemComponent = Ember.Component.extend(Encompass.DragNDrop.Droppable, Encompass.DragNDrop.Draggable, {
  ...
  putInFolder: function putInFolder(folder, type, data) {
  ...
  putSelectionInFolder: function putSelectionInFolder(id, folder) {
    console.log("Put selection (folder-elem) in folder");
  },

  putFolderInFolder: function putFolderInFolder(child, parent) {
  ...
  actions: {
    ...
    showFolder: function showFolder() {
      console.log("Show folder!");
    }
  }
});
//# sourceMappingURL=folder-elem.js.map
