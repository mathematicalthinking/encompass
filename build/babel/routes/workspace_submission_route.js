...
Encompass.WorkspaceSubmissionRoute = Ember.Route.extend({
  ...
  */
  ...
  actions: {
    ...
    startTour: function startTour(type) {
    ...
    fileSelectionInFolder: function fileSelectionInFolder(selectionId, folder) {
      console.log('tagging selection: ' + selectionId);
      var store = this.get('store');

      folder.get('workspace').then(function (workspace) {
        workspace.get('selections').then(function (selections) {
...
//# sourceMappingURL=workspace_submission_route.js.map
